...
PRIORITY_RULES = [
    ...
    # 우선순위 5: 해열진통제 복용자
    (5, re.compile(r"해열진통제")),
    # 우선순위 6: MAO 억제제
    (6, re.compile(r"MAO\s*억제제|모노아민\s*산화효소|항우울제|항정신병")),
    # 우선순위 7: 불내성·결핍증·흡수장애
    (7, re.compile(r"불내성|결핍증|흡수장애")),
    # 우선순위 8: 간장애
    (8, re.compile(r"간장애")),
    # 우선순위 9: 신장 관련
    (9, re.compile(r"신장|신부전|신장애")),
    # 우선순위 10: 심장/혈압 관련
    (10, re.compile(r"심장|고혈압|혈압|심부전")),
    # 우선순위 11: 위장 관련
    (11, re.compile(r"위장|궤양|출혈")),
    # 우선순위 12: 항암 관련
    (12, re.compile(r"항암|메토트렉세이트")),
    # 우선순위 13: 수술 관련
    (13, re.compile(r"수술|우회로")),
]
